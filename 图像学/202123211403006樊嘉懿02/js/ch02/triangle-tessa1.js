...
window.onload = function initTriangles(){
	...
	var vertices = [
        radius * Math.cos(90 * Math.PI / 180.0) * Math.cos(theta) - radius * Math.sin(90 * Math.PI / 180.0) * Math.sin(theta),
        radius * Math.cos(90 * Math.PI / 180.0) * Math.sin(theta) + radius * Math.sin(90 * Math.PI / 180.0) * Math.cos(theta),
        0,
        radius * Math.cos(210 * Math.PI / 180.0) * Math.cos(theta) - radius * Math.sin(210 * Math.PI / 180.0) * Math.sin(theta),
        radius * Math.cos(210 * Math.PI / 180.0) * Math.sin(theta) + radius * Math.sin(210 * Math.PI / 180.0) * Math.cos(theta),
        0,
        radius * Math.cos(-30 * Math.PI / 180.0) * Math.cos(theta) - radius * Math.sin(-30 * Math.PI / 180.0) * Math.sin(theta),
        radius * Math.cos(-30 * Math.PI / 180.0) * Math.sin(theta) + radius * Math.sin(-30 * Math.PI / 180.0) * Math.cos(theta),
        0,
    ]
    ...
    document.getElementById( "numtime" ).onchange = function( event ){
		points = [];
		numTimesToSubdivide = numTime.value;
		initTriangles();
	}

	document.getElementById( "theta1" ).onchange = function( event ){
		points = [];
		theta = theta1.value;
		initTriangles();
	}
