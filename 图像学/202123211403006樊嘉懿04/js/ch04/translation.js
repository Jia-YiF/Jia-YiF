...
window.onload = function initCube() {
    ...
    document.getElementById( "x-pos" ).onchange = function( event ){
		pos[0] = x-pos.value;
	}
    document.getElementById( "y-pos" ).onchange = function( event ){
		pos[1] = y-pos.value;
	}
    document.getElementById( "z-pos" ).onchange = function( event ){
		pos[2] = z-pos.value;
	}
